...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-[#0b0d12] pt-40 pb-24 text-white">
      ...
      <div className="relative z-20 mx-auto max-w-5xl px-6 text-center">
        ...
        >
          ...
          <motion.h1
            variants={fadeInUp}
            className="max-w-4xl text-balance text-4xl font-display font-semibold leading-tight sm:text-5xl md:text-6xl"
          >
            One Platform for
            <br />
          ...
          >
            ML, GenAI (RAG/agents), automation, computer vision, data engineering, and MLOps—delivered securely and at scale.
          </motion.p>
