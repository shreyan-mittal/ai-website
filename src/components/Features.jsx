...
const services = [
  {
    ...
    description: "Define high-impact use-cases, assess data readiness, and ship an execution plan aligned to ROI, risk, and timelines.",
    icon: "🧭",
  },
  {
    title: "Custom Model Development",
    description: "Train and fine-tune ML/LLM systems for your domain—accuracy, latency, and cost optimized for production.",
    icon: "🧠",
  },
  {
    title: "GenAI Apps & Agents",
    description: "Production-grade copilots, RAG pipelines, and agent workflows with guardrails, evals, and human-in-the-loop.",
    icon: "🤖",
  },
  {
    title: "Computer Vision Systems",
    description: "Detection, OCR, and visual inspection pipelines for real-time perception and quality intelligence.",
    icon: "👁️",
  },
  {
    title: "MLOps & Deployment",
    description: "CI/CD for models, monitoring, drift detection, and scalable inference across cloud, edge, and on-prem.",
    icon: "🚀",
  },
  {
    title: "Data Engineering",
    description: "Pipelines, warehouses, and feature layers to power reliable, secure AI at scale.",
    icon: "🗄️",
  },
]
