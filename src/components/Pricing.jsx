    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <motion.h2
            variants={fadeInUp}
            className="mt-6 text-balance text-4xl font-display font-semibold leading-tight sm:text-5xl"
          >
          ...
          <motion.p variants={fadeInUp} className="mt-4 text-lg text-white/70">
            Teams get stuck on hype, tooling, and fragmented pilots. We bring practical guidance, then build systems that are measurable, secure, and scalable.
          </motion.p>
        </motion.div>
